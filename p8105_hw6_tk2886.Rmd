...
```{r}
birthweight_model <- lm(bwt ~ fincome + mrace + smoken + momage + mheight + bhead + blength + mheight * delwt * momage,  data = birthwgt_df)
```
...
The weather data set for this problem has `r weather_row` rows. 
