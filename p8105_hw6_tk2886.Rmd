...
```
From this correlation matrix, I will use specific predictors in my regression model. 
...
```
**Explanation of My model:** My modeling process involves using the correlation matrix that I created above and based on the p-value (if it's closer to 1 then the outcome and the predictor has significant correlation) and I selected the predictors that has significant or somewhat significant correlation with the outcome and included those predictors in my model. 
