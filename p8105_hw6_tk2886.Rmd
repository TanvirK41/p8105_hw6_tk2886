...
cv_df %>% 
  ...
  geom_boxplot() +
  labs(
    title = "Model and Root Mean Square Error",
    x = "Model",
...
**Interpretation: ** The distribution is somewhat normally distributed. The r-squared values in this case peaks around .915
...
*Interpretation:* The distribution is somewhat normally distributed. 
