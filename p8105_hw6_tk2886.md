...
it’s closer to one the outcome and the predictor has significant
correlation) and I selected the predictors that has somewhat significant
correlation with the outcome and included those predictors in my model.
...
4.  **gaweeks - Gestational Weeks** The slope in term in our model is
    saying that for every 1 increase in the gestational weight, the baby
    birth weight goes by up 13.69 keeping every other variable constant.
